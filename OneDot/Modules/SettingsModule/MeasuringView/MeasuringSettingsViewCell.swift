...
class MeasuringSettingsViewCell: SettingsBaseViewCell {
    ...
    private func setViews() {
        ...
        setTitleSettings(countdownTitle, "Countdown", .gray, 16)
...
//            mainTitle.topAnchor.constraint(equalTo: topAnchor, constant: 40),
            ...
            unitTitle.bottomAnchor.constraint(equalTo:
                                            unitStack.topAnchor, constant:
                                           -stackSpacing),
            ...
            temperatureTitle.bottomAnchor.constraint(equalTo:
                                            temperatureStack.topAnchor,
            ...
            autopauseTitle.bottomAnchor.constraint(equalTo:
                                            autopauseStack.topAnchor,
                                            constant: -stackSpacing),
            ...
            countdownTitle.centerXAnchor.constraint(equalTo:
                                            countDownStack.centerXAnchor),
            countdownTitle.bottomAnchor.constraint(equalTo:
                                            countDownStack.topAnchor,
                                            constant: -stackSpacing),
